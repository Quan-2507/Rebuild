            ...
            <MDBRow>
                ...
                <MDBCol col='4' md='6'>
                    <div className="d-flex flex-row align-items-center justify-content-center">
                        <p className="lead fw-normal mb-0 me-3">Đăng ký với </p>
                    ...
                    <div className='text-center text-md-start mt-4 pt-2'>
                        ...
                        >Đăng nhập</MDBBtn>
                        <p className="small fw-bold mt-2 pt-1 mb-2">Bạn chưa có tài khoản ? <a href="/register" className="link-danger">Đăng ký</a></p>
                    </div>
